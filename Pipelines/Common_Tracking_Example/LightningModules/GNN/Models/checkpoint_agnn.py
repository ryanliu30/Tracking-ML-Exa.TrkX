...
class CheckpointedResAGNN(GNNBase):
    def __init__(self, hparams):
        ...
        self.edge_network = make_mlp(
            ...
            [hparams["spatial_channels"] + hparams["cell_channels"] + hparams["hidden"],hparams["spatial_channels"] + hparams["cell_channels"] + hparams["hidden"]] * hparams["nb_edge_layer"] + [1],
        ...
        self.node_network = make_mlp(
            (hparams["spatial_channels"] + hparams["cell_channels"] + hparams["hidden"]) * 2,
            [hparams["hidden"],hparams["hidden"]] * hparams["nb_node_layer"],
            hidden_activation=hparams["hidden_activation"],
